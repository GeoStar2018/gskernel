...
class CWtl_osgbcheckView : public CWindowImpl<CWtl_osgbcheckView>, public UTILITY_NAME::GsCustomLogOutput
{
...
public:
	PointCloudLayer* m_PointLayer;
	DECLARE_WND_CLASS(NULL)

	virtual bool OnLog(const char* log);
	BOOL PreTranslateMessage(MSG* pMsg);

	BEGIN_MSG_MAP(CWtl_osgbcheckView)
