...
public:
	...
	CWtl_showpagelayoutView m_view;
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_ID_HANDLER(ID_FULLMAP, OnFullMap)
		COMMAND_ID_HANDLER(ID_ZOOMIN, OnZoomIn)
		COMMAND_ID_HANDLER(ID_ZOOMOUT, OnZoomOut)
		COMMAND_ID_HANDLER(ID_ZOOMPAN, OnZoomPan)
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	LRESULT OnFullMap(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
	{
		m_view.FullMap();
		return S_OK;
	}
	...
	LRESULT OnZoomPan(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
	{
		m_view.ZoomPan();
		return S_OK;
	}
