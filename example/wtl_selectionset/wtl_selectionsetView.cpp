...
#include "wtl_selectionsetView.h"
#include <atltypes.h>
using namespace GeoStar::Kernel;
using namespace GeoStar::Utility;
CWtl_selectionsetView::CWtl_selectionsetView()
{
	m_Cursor = NULL;
...
bool CWtl_selectionsetView::OnLog(const char* log)
{
	//输出到vs运行栏，方便调试
	OutputDebugStringA(log);
	return true;
}
BOOL CWtl_selectionsetView::PreTranslateMessage(MSG* pMsg)
{
	pMsg;
	return FALSE;
}
void CWtl_selectionsetView::OnExtentChanged(const KERNEL_NAME::GsBox& box)
{
	m_ptrMap->Cancel();
	m_ptrMap->ViewExtent(box);
	m_ptrMap->Update();
}
bool CWtl_selectionsetView::OnUpdate(GsRefObject* ref, int reason, const GsBox& extent, double res, void* param)
{
...
LRESULT CWtl_selectionsetView::OnTimer(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
void CWtl_selectionsetView::OpenData()
{
...
void CWtl_selectionsetView::CreateMap()
{
	if(m_ptrMap)
		return;
	...
	m_ptrAgent->OnNeedUpdate.Add(this, &CWtl_selectionsetView::OnUpdate);
	...
	m_ptrPanTracker->OnExtentChanged.Add(this, &CWtl_selectionsetView::OnExtentChanged);

	m_ptrSelectTracker = new KERNEL_NAME::GsNewEnvelopeTracker(m_ptrMap);
	m_ptrSelectTracker->OnGeometryTracked.Add(this, &CWtl_selectionsetView::OnSelect);
	ZoomPan();
}
...
KERNEL_NAME::GsSymbolTracker::GsTrackerFeedBack CWtl_selectionsetView::OnSelect(KERNEL_NAME::GsGeometry* geo)
{
...
LRESULT CWtl_selectionsetView::OnMouseDown(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
{
	if (m_CurrentTracker)
	{
...
LRESULT CWtl_selectionsetView::OnMouseUp(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
{
	if (m_CurrentTracker)
	{
		int x = GET_X_LPARAM(lParam);
...
LRESULT CWtl_selectionsetView::OnMouseWheel(UINT /*uMsg*/, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
{
	if (m_CurrentTracker)
	{
...
LRESULT CWtl_selectionsetView::OnMouseMove(UINT /*uMsg*/, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
{
	if (m_Cursor)
		SetCursor(m_Cursor);
...
LRESULT CWtl_selectionsetView::OnPaint(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	CreateMap();
	CPaintDC dc(m_hWnd);
...
LRESULT CWtl_selectionsetView::OnSize(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
